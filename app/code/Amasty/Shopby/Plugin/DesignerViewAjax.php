...
/**
 * Class Designer view index Ajax
 */
class DesignerViewAjax
{
    ...
    \Amasty\Shopby\Helper\Data $helper, \Magento\Framework\Controller\Result\RawFactory $resultRawFactory
    )
    {
        $this->helper = $helper;
    ...
    /**
     * @param \SS\Designer\Controller\View\Index $controller
     * @param                                           $page
     *
     * @return \Magento\Framework\Controller\Result\Raw|\Magento\Framework\View\Result\Page
     */
    public function afterExecute(\SS\Designer\Controller\View\Index $controller, $page)
    {
