...
class AbstractBlock extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function getRuleTrigerImage(){
        return   $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_STATIC).'adminhtml/Magento/backend/en_US/images/rule_chooser_trigger.gif';
    }
}