...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_LIST_ESSENTIAL = 'magemonkey/general/list_essential';
    const XML_PATH_LIST_EDITORIAL = 'magemonkey/general/list_editorial';
    ...
    \Magento\Framework\App\Helper\Context $context, \Magento\Store\Model\StoreManagerInterface $storeManager, \Ebizmarts\MageMonkey\Model\Logger\Magemonkey $logger, \Magento\Customer\Api\GroupRepositoryInterface $groupRepositoryInterface
    )
    {
    ...
    public function getEssentialList($store = null)
    {
        return $this->scopeConfig->getValue(self::XML_PATH_LIST_ESSENTIAL, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    
    public function getEditorialList($store = null)
    {
        return $this->scopeConfig->getValue(self::XML_PATH_LIST_EDITORIAL, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
