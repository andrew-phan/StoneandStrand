 ...
 */
class MassDelete extends \Ss\Slideshow\Controller\Adminhtml\Banner
{
    ...
    public function execute()
    {
        ...
        if (!is_array($bannerIds) || empty($bannerIds)) {
            ...
            $bannerCollection = $this->_objectManager->create('Ss\Slideshow\Model\ResourceModel\Banner\Collection')
