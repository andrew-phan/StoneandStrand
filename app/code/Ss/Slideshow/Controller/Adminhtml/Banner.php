 ...
 */
abstract class Banner extends \Ss\Slideshow\Controller\Adminhtml\AbstractAction
{
    ...
    {
        return $this->_authorization->isAllowed('Ss_Slideshow::slideshow_banners');
    }
        ...
        switch ($this->getRequest()->getParam('back')) {
            case 'edit':
                $resultRedirect->setPath(
                    '*/*/edit', [static::PARAM_CRUD_ID => $paramCrudId,
                    '_current' => true, 'store' => $this->getRequest()->getParam('store'),
