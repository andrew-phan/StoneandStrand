...
namespace Ss\Slideshow\Block\Adminhtml\Widget;
 ...
 */
class Chooser extends \Ss\Slideshow\Block\Adminhtml\Banner\Grid
{
    ...
    \Magento\Backend\Block\Template\Context $context, \Magento\Backend\Helper\Data $backendHelper, \Ss\Slideshow\Model\ResourceModel\Banner\Collection $bannerCollectionFactory, \Magento\Framework\Data\Form\Element\Factory $elementFactory, array $data = []
    )
    {
        parent::__construct($context, $backendHelper, $bannerCollectionFactory, $data);
    ...
    {
        return $this->getUrl(
                'ss_slideshow/banner_widget/chooser', [
                '_current' => true,
                ]
        );
    }
    ...
    public function setSelectedBanners($selectedBanners)
    {
        ...
        if (is_array($selectedBanners) && count($selectedBanners) == 1 && empty($selectedBanners[0])) {
            $selectedBanners = 0;
        }
