 ...
 */
abstract class Type extends \Ss\Designer\Controller\Adminhtml\AbstractAction
{

    const PARAM_CRUD_ID = 'type_id';
    ...
    {
        return $this->_authorization->isAllowed('Ss_Designer::designer_type');
    }
        ...
        $paramCrudId = null)
    {
        $params = [
            ...
            'current_tag_id' => $this->getRequest()->getParam('current_type_id'),
