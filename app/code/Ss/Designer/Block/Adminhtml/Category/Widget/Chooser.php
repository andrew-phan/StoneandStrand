...
namespace Ss\Designer\Block\Adminhtml\Category\Widget;
...
class Chooser extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            'catalog/category_widget/chooser', ['uniq_id' => $uniqId, 'use_massaction' => false]
        );
    ...
    {
        return $this->getUrl(
                'catalog/category_widget/categoriesJson', ['_current' => true, 'uniq_id' => $this->getId(), 'use_massaction' => $this->getUseMassaction()]
        );
    }
