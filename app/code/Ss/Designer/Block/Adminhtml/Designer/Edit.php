...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->getRequest()->getParam('current_designer_id')) {
            ...
            if ($bannerId = $this->getRequest()->getParam('designer_id')) {
                $this->_formScripts[] = '
					window.designer_id = ' . $bannerId . ';
				';
            }
        } else {
            $this->buttonList->add(
    ...
    protected function getSaveAndContinueUrl()
    {
        return $this->getUrl(
                ...
                'designer_id' => $this->getRequest()->getParam('designer_id'),
