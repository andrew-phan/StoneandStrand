...
namespace Ss\Designer\Block\Adminhtml\Widget\Tag;
 ...
 */
class Chooser extends \Ss\Designer\Block\Adminhtml\Tags\Grid
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context,
        ...
        array $data = array())
    {
        parent::__construct($context, $backendHelper, $tagCollection, $wysiwygConfig, $data);
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->_selectedTags = explode(',', $element->getValue());
    ...
    {
        return $this->getUrl(
                'stone_designer/tags_widget/chooser', [
                '_current' => true,
                ]
        );
    }
    ...
    public function setSelectedTags($selectedTags)
    {
        ...
        if (is_array($selectedTags) && count($selectedTags) == 1 && empty($selectedTags[0])) {
            $selectedTags = 0;
        }
    ...
    public function getSelectedTags()
    {
        ...
        if ($selectedTags = $this->getRequest()->getParam('selected_tags', $this->_selectedTags)) {
    ...
    public function getRowInitCallback()
    {
        ...
        function(grid, row){
            ...
            '\').value.split(\',\');
                ...
                grid.reloadParams = {};
                grid.reloadParams[\'selected_tags[]\'] = Object.keys(grid.selBannersIds);
            }
    ...
    public function getRowClickCallback()
    {
        return '
            ...
            '\').value = banners.join(\',\');
                grid.reloadParams = {};
                grid.reloadParams[\'selected_tags[]\'] = banners;
            }
        ';
    }
