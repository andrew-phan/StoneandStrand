...
namespace Ss\Checkout\Block\Override\Adminhtml\Promo\Quote\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $couponMessageFiled = $fieldset->addField(
            'coupon_message',
            'textarea',
            [
                'name' => 'coupon_message',
                'label' => __('Coupon Message'),
                'title' => __('Coupon Message'),
                'style' => 'height: 100px;'
            ]
        );
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(
                ...
                $couponMessageFiled->getHtmlId(),
                $couponMessageFiled->getName()
            )->addFieldMap(
