 ...
 * Save Collection.
 */
class Save extends \Ss\Collection\Controller\Adminhtml\Collection
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\Ss\Collection\Model\Collection::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \Ss\Collection\Model\Collection::BASE_MEDIA_PATH . $result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The collection has been saved.'));
