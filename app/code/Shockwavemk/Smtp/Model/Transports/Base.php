        ...
        $parameters = null)
    {
        switch ( $config->getType() )
        {
            case $config::TYPE_MAILGUN:
                ...
                break;
            case $config::TYPE_MANDRILL:
                $this->_transport = new MandrillTransport($config, $message, $parameters);
                break;
            case $config::TYPE_SENDGRID:
                $this->_transport = new SendgridTransport($config, $message, $parameters);
                break;
            default:
