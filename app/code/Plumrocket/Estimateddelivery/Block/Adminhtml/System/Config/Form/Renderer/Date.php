    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        switch ($this->getColumn()->getData('id')) {
            case 'recurring_date':
                ...
                $monthsSelect = $this->_objectManager->create('Magento\Framework\Data\Form\Element\Select', ['data' => array_merge($params, [
                ...
                $daysSelect = $this->_objectManager->create('Magento\Framework\Data\Form\Element\Select', ['data' => array_merge($params, [
            ...
            case 'period':
                $date = $this->_objectManager->create('Magento\Framework\Data\Form\Element\Date', ['data' => array_merge($dateParams, [
            ...
            case 'single_day':
            default:
                $date = $this->_objectManager->create('Magento\Framework\Data\Form\Element\Date', ['data' => $dateParams]);
