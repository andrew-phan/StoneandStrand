...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @return type
     */
    public function getFeatureImageUrl($defaultImage = null)
    {
        $featureImage = $this->getFeaturedImg();

        if (empty($featureImage)) {
            if (!$defaultImage) {
                return $this->_themeHelper->getPlaceHolderImage();
            } else {
                return $this->_url->getMediaUrl($defaultImage);
            }
        }

        return $this->_url->getMediaUrl($featureImage);
    }
