            ...
            validateShippingInformation: function () {
                ...
                if (!customer.isLoggedIn()) {
                    $(loginFormSelector).validation({
                        messages: {
                            username: {
                                required: '<span class="img-icon icon-error" data-toggle-error="">&nbsp;</span><p class="hidden">This is a required field.</p>',
                        ...
                        highlight: function(element) {
                            $(element).addClass('mage-error').closest('.field').addClass('_error');
                        },
                        unhighlight: function(element) {
                            $(element).removeClass('mage-error').closest('.field').removeClass('_error');
                        }
                    });
